...
public class ControlaJogadorOld_2 : MonoBehaviourPunCallbacks
{
...
#pragma warning disable 649
    ...
    [Tooltip("The position of the player and gun camera relative to the fps controller GameObject."), SerializeField]
    ...
    */
    ...
    [Tooltip("Minimum rotation of the player and camera on the x axis."),
     SerializeField]
    private float minVerticalAngle = -90f;

    [Tooltip("Maximum rotation of the player and camera on the axis."),
     SerializeField]
...
#pragma warning restore 649
    ...
    private void Update()
    {
        ...
        player.position = transform.position + transform.TransformVector(armPosition);
        Jump();
        PlayFootstepSounds();
    ...
    private void RotateCameraAndCharacter()
    {
        ...
        transform.eulerAngles = new Vector3(rotation.eulerAngles.x, rotation.eulerAngles.y, rotation.eulerAngles.z);
